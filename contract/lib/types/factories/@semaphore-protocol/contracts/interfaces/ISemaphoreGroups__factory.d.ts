...
import type { ISemaphoreGroups, ISemaphoreGroupsInterface } from "../../../../@semaphore-protocol/contracts/interfaces/ISemaphoreGroups";
export declare class ISemaphoreGroups__factory {
