...
export interface SemaphoreInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addMember" | "addMembers" | "createGroup(uint256,uint256,address,uint256)" | "createGroup(uint256,uint256,address)" | "getMerkleTreeDepth" | "getMerkleTreeRoot" | "getNumberOfMerkleTreeLeaves" | "groups" | "removeMember" | "updateGroupAdmin" | "updateGroupMerkleTreeDuration" | "updateMember" | "verifier" | "verifyProof"): FunctionFragment;
...
export interface Semaphore extends BaseContract {
    ...
    functions: {
        ...
        "createGroup(uint256,uint256,address,uint256)"(groupId: PromiseOrValue<BigNumberish>, merkleTreeDepth: PromiseOrValue<BigNumberish>, admin: PromiseOrValue<string>, merkleTreeDuration: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "createGroup(uint256,uint256,address)"(groupId: PromiseOrValue<BigNumberish>, merkleTreeDepth: PromiseOrValue<BigNumberish>, admin: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "createGroup(uint256,uint256,address,uint256)"(groupId: PromiseOrValue<BigNumberish>, merkleTreeDepth: PromiseOrValue<BigNumberish>, admin: PromiseOrValue<string>, merkleTreeDuration: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        "createGroup(uint256,uint256,address)"(groupId: PromiseOrValue<BigNumberish>, merkleTreeDepth: PromiseOrValue<BigNumberish>, admin: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        getMerkleTreeDepth(groupId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        getMerkleTreeRoot(groupId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        getNumberOfMerkleTreeLeaves(groupId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        groups(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[
